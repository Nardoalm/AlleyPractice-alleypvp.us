package com.kaosmc.practice.feature.title.internal;
...
import com.kaosmc.practice.common.text.TextFormatter;
...
public class TitleServiceImpl implements TitleService {
    ...
    private String getPrefixBasedOnHighestDivision(Kit kit) {
        Division highestDivision = KaosPractice.getInstance().getService(DivisionService.class).getHighestDivision();
