...
public class MusicServiceImpl implements MusicService {
    ...
    public void startMusic(Player player) {
        ...
        List<String> message = KaosPractice.getInstance().getService(LocaleService.class).getStringList(GlobalMessagesLocaleImpl.MUSIC_DISC_NOW_PLAYING);
        ...
        session.setTask(task.runTaskTimer(KaosPractice.getInstance(), 20L, 20L));
