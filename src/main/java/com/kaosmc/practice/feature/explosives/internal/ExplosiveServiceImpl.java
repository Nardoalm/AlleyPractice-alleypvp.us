...
import com.kaosmc.practice.feature.explosives.listener.ExplosiveListener;
...
public class ExplosiveServiceImpl implements ExplosiveService {
     ...
     *
     * @param plugin        The main KaosPractice instance.
     * @param configService The configuration service.
     * @param localeService The locale service.
     */
    public ExplosiveServiceImpl(KaosPractice plugin, ConfigService configService, LocaleService localeService) {
        this.plugin = plugin;
