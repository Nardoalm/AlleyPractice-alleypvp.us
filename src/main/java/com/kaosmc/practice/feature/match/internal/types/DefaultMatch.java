...
import com.kaosmc.practice.common.elo.OldEloResult;
...
import com.kaosmc.practice.feature.kit.setting.types.mechanic.KitSettingDropItemsImpl;
import com.kaosmc.practice.feature.kit.setting.types.mode.KitSettingRaiding;
import com.kaosmc.practice.feature.kit.setting.types.mode.KitSettingRespawnTimer;
...
import com.kaosmc.practice.feature.match.utility.MatchUtility;
...
//        List<String> message;
//
//        DivisionTier reachedTier = KaosPractice.getInstance().getService(DivisionService.class).getDivisions().stream()
...
//        message.forEach(line -> winner.sendMessage(CC.translate(line)));
    ...
    public @NotNull EloResult getEloResult(int oldWinnerElo, int oldLoserElo) {
        EloCalculator eloCalculator = KaosPractice.getInstance().getService(EloCalculator.class);
