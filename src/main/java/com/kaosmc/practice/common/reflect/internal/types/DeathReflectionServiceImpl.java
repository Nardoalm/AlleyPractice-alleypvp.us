...
public class DeathReflectionServiceImpl implements Reflection {
    ...
    /**
     * Sets the entity ID for a packet using reflect from the IReflection interface.
     *
    ...
    /**
     * Sets the status byte for the entity status packet using reflect from the IReflection interface.
     *
