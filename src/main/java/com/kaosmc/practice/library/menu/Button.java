...
public abstract class Button {
    ...
    public String getAdminPermission() {
        return KaosPractice.getInstance().getService(PluginConstant.class).getAdminPermissionPrefix();
    }
    ...
    private LocaleService getLocaleService() {
        return KaosPractice.getInstance().getService(LocaleService.class);
    }
