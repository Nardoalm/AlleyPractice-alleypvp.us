package us.alleypvp.practice.core.profile.data;

import com.google.common.collect.Maps;
import us.alleypvp.practice.AlleyPractice;
import us.alleypvp.practice.core.profile.data.types.*;
...
public class ProfileData {
    ...
    public void determineTitles() {
        TitleService titleService = AlleyPractice.getInstance().getService(TitleService.class);
    ...
    public void updateElo(Profile profile) {
        LevelService levelService = AlleyPractice.getInstance().getService(LevelService.class);
    ...
    private void sendLevelUpMessage(Profile profile, String newLevel) {
        Arrays.asList(
                "",
                "&b&lNOVO NÍVEL &f| &a&lPARABÉNS!",
                " &fVocê alcançou &b" + newLevel + " &fno sistema global de ranking.",
                ""
