package us.alleypvp.practice.core.profile;
...
import us.alleypvp.practice.feature.abilities.cooldown.AbilityCooldown;
...
public class Profile {
    ...
    public ChatColor getNameColor() {
        CoreAdapter adapter = AlleyPractice.getInstance().getService(CoreAdapter.class);
        if (adapter == null || adapter.getCore() == null) {
            return this.nameColor != null ? this.nameColor : ChatColor.WHITE;
        }

        Player p = AlleyPractice.getInstance().getServer().getPlayer(this.uuid);
        if (p == null) {
            return this.nameColor != null ? this.nameColor : ChatColor.WHITE;
        }
    ...
    public String getNextDivisionAndTier(String kitName) {
        ...
        DivisionService divisionService = AlleyPractice.getInstance().getService(DivisionService.class);
