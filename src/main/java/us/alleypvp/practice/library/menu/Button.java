...
public abstract class Button {
    ...
    public String getAdminPermission() {
        return AlleyPractice.getInstance().getService(PluginConstant.class).getAdminPermissionPrefix();
    }
    ...
    private LocaleService getLocaleService() {
        return AlleyPractice.getInstance().getService(LocaleService.class);
    }
