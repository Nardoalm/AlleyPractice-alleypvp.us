package us.alleypvp.practice.feature.title.internal;
...
public class TitleServiceImpl implements TitleService {
    ...
    private String getPrefixBasedOnHighestDivision(Kit kit) {
        Division highestDivision = AlleyPractice.getInstance().getService(DivisionService.class).getHighestDivision();
