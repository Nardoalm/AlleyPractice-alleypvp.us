package us.alleypvp.practice.feature.hotbar.internal;
...
import us.alleypvp.practice.feature.party.menu.duel.PartyDuelMenu;
...
import us.alleypvp.practice.feature.queue.menu.sub.RankedMenu;
...
public class HotbarServiceImpl implements HotbarService {
    ...
    public void applyHotbarItems(Player player, HotbarType type) {
        ...
        AlleyPractice.getInstance().getServer().getScheduler().runTaskLater(AlleyPractice.getInstance(), player::updateInventory, 1L);
    }
