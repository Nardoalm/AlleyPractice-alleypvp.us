package us.alleypvp.practice.feature.explosives.internal;
...
import us.alleypvp.practice.feature.explosives.listener.ExplosiveListener;
...
public class ExplosiveServiceImpl implements ExplosiveService {
     ...
     *
     * @param plugin        The main AlleyPractice instance.
     * @param configService The configuration service.
     * @param localeService The locale service.
     */
    public ExplosiveServiceImpl(AlleyPractice plugin, ConfigService configService, LocaleService localeService) {
        this.plugin = plugin;
