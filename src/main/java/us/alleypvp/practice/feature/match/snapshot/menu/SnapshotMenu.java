package us.alleypvp.practice.feature.match.snapshot.menu;
...
import us.alleypvp.practice.feature.match.snapshot.menu.button.SnapshotDataButton;
import us.alleypvp.practice.feature.match.snapshot.menu.button.SnapshotOpponentButton;
import us.alleypvp.practice.feature.match.snapshot.menu.button.items.SnapshotArmorButton;
import us.alleypvp.practice.feature.match.snapshot.menu.button.items.SnapshotInventoryButton;
...
public class SnapshotMenu extends Menu {
    ...
    public String getTitle(Player player) {
        String title = AlleyPractice.getInstance().getService(ConfigService.class).getMenusConfig().getString("menus.snapshot-menu.title", "&b&lInventario de {name}");
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        FileConfiguration config = AlleyPractice.getInstance().getService(ConfigService.class).getMenusConfig();
