package us.alleypvp.practice.feature.music.internal;
...
public class MusicServiceImpl implements MusicService {
    ...
    public void startMusic(Player player) {
        ...
        List<String> message = AlleyPractice.getInstance().getService(LocaleService.class).getStringList(GlobalMessagesLocaleImpl.MUSIC_DISC_NOW_PLAYING);
        ...
        session.setTask(task.runTaskTimer(AlleyPractice.getInstance(), 20L, 20L));
