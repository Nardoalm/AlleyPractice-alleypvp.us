package us.alleypvp.practice.common.server;

import us.alleypvp.practice.AlleyPractice;
import us.alleypvp.practice.common.server.listener.ServerEnvironmentListener;
...
public class ServerEnvironmentImpl implements ServerEnvironment {
     ...
     */
    public ServerEnvironmentImpl(AlleyPractice plugin) {
        this.plugin = plugin;
